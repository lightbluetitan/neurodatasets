...
neurophysiological measurements from a study of 15 violin and other
string instrument players. The data examines the relationship between
years of musical practice and measured brain activity levels in relevant
cortical regions.
...
The dataset name has been kept as 'brain_string_players_df' to avoid
